...
namespace DatabaseApproach.Controllers
{
    public class employeeDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmpId,EmpName,EmpSalary,DeptId,Address,dob,Mobiles,Status,CreatedBy,MobileNo,Available")] employeeDetail employeeDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmpId,EmpName,EmpSalary,DeptId,Address,dob,Mobiles,Status,CreatedBy,MobileNo,Available")] employeeDetail employeeDetail)
        {
            if (ModelState.IsValid)
            {
